...
type Ship struct {
	...
	Type          *TypeSummary           `protobuf:"bytes,3,opt,name=type,proto3" json:"type,omitempty"`
	Class         *ClassSummary          `protobuf:"bytes,4,opt,name=class,proto3" json:"class,omitempty"`
	Country       *CountrySummary        `protobuf:"bytes,5,opt,name=country,proto3" json:"country,omitempty"`
	Name          string                 `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty"`
	Mmsi          int64                  `protobuf:"varint,7,opt,name=mmsi,proto3" json:"mmsi,omitempty"`
	CallSign      *CallSignSummary       `protobuf:"bytes,8,opt,name=call_sign,json=callSign,proto3" json:"call_sign,omitempty"`
	...
	Captains      []*CaptainSummary      `protobuf:"bytes,14,rep,name=captains,proto3" json:"captains,omitempty"`
	Permissions   []*PermissionSummary   `protobuf:"bytes,15,rep,name=permissions,proto3" json:"permissions,omitempty"`
...
func (x *Ship) GetType() *TypeSummary {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *Ship) GetClass() *ClassSummary {
	if x != nil {
		return x.Class
	}
	return nil
...
func (x *Ship) GetCountry() *CountrySummary {
	if x != nil {
		return x.Country
	}
	return nil
...
func (x *Ship) GetCallSign() *CallSignSummary {
	if x != nil {
		return x.CallSign
	}
	return nil
...
func (x *Ship) GetCaptains() []*CaptainSummary {
	if x != nil {
		return x.Captains
	}
	return nil
...
func (x *Ship) GetPermissions() []*PermissionSummary {
	if x != nil {
...
const file_apfish_ship_ship_ship_proto_rawDesc = "" +
	"\n" +
	"\x1bapfish/ship/ship/ship.proto\x12\x04ship\x1a\x1fgoogle/protobuf/timestamp.proto\x1a-apfish/ship/ship_type/ship_type_summary.proto\x1a%apfish/ship/class/class_summary.proto\x1a-apfish/location/country/country_summary.proto\x1a(apfish/call_sign/call_sign_summary.proto\x1a)apfish/ship/captain/captain_summary.proto\x1a5apfish/permission/permission/permission_summary.proto\"\xda\x04\n" +
	"\x04Ship\x12\x0e\n" +
	...
	"\vpermissions\x18\x0f \x03(\v2\x1d.permission.PermissionSummaryR\vpermissionsB\x14Z\x12apfish.v1;apfishv1b\x06proto3"
...
var file_apfish_ship_ship_ship_proto_goTypes = []any{
	...
	(*TypeSummary)(nil),           // 1: ship.TypeSummary
	(*ClassSummary)(nil),          // 2: ship.ClassSummary
	(*CountrySummary)(nil),        // 3: location.CountrySummary
	(*CallSignSummary)(nil),       // 4: call_sign.CallSignSummary
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
	(*CaptainSummary)(nil),        // 6: ship.CaptainSummary
	(*PermissionSummary)(nil),     // 7: permission.PermissionSummary
}
