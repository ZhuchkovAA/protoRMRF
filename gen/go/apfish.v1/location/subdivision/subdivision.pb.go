...
func (x *SubDivision) Reset() {
	*x = SubDivision{}
	mi := &file_apfish_v1_location_subdivision_subdivision_proto_msgTypes[0]
...
func (*SubDivision) Descriptor() ([]byte, []int) {
	return file_apfish_v1_location_subdivision_subdivision_proto_rawDescGZIP(), []int{0}
}

func (x *SubDivision) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SubDivision) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *SubDivision) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
var File_apfish_v1_location_subdivision_subdivision_proto protoreflect.FileDescriptor

const file_apfish_v1_location_subdivision_subdivision_proto_rawDesc = "" +
	"\n" +
...
var (
	file_apfish_v1_location_subdivision_subdivision_proto_rawDescOnce sync.Once
	file_apfish_v1_location_subdivision_subdivision_proto_rawDescData []byte
)

func file_apfish_v1_location_subdivision_subdivision_proto_rawDescGZIP() []byte {
	file_apfish_v1_location_subdivision_subdivision_proto_rawDescOnce.Do(func() {
		file_apfish_v1_location_subdivision_subdivision_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_apfish_v1_location_subdivision_subdivision_proto_rawDesc), len(file_apfish_v1_location_subdivision_subdivision_proto_rawDesc)))
	})
	return file_apfish_v1_location_subdivision_subdivision_proto_rawDescData
}
...
func init() { file_apfish_v1_location_subdivision_subdivision_proto_init() }
func file_apfish_v1_location_subdivision_subdivision_proto_init() {
	if File_apfish_v1_location_subdivision_subdivision_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_apfish_v1_location_subdivision_subdivision_proto_rawDesc), len(file_apfish_v1_location_subdivision_subdivision_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_apfish_v1_location_subdivision_subdivision_proto_goTypes,
		DependencyIndexes: file_apfish_v1_location_subdivision_subdivision_proto_depIdxs,
		MessageInfos:      file_apfish_v1_location_subdivision_subdivision_proto_msgTypes,
	}.Build()
	File_apfish_v1_location_subdivision_subdivision_proto = out.File
	file_apfish_v1_location_subdivision_subdivision_proto_goTypes = nil
	file_apfish_v1_location_subdivision_subdivision_proto_depIdxs = nil
}
