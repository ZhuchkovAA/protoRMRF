...
const (
	ShipService_GetShip_FullMethodName        = "/apfish.v1.ship.ShipService/GetShip"
	ShipService_GetShipSummary_FullMethodName = "/apfish.v1.ship.ShipService/GetShipSummary"
	ShipService_ListShips_FullMethodName      = "/apfish.v1.ship.ShipService/ListShips"
)
...
var ShipService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "apfish.v1.ship.ShipService",
	...
	Metadata: "apfish.v1/ship/ship_service.proto",
}
