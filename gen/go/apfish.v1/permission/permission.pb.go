...
type Permission struct {
	...
	Users         []*summary5.UserSummary     `protobuf:"bytes,11,rep,name=users,proto3" json:"users,omitempty"`
	Roles         []*summary6.RoleSummary     `protobuf:"bytes,12,rep,name=roles,proto3" json:"roles,omitempty"`
...
func (x *Permission) GetUsers() []*summary5.UserSummary {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *Permission) GetRoles() []*summary6.RoleSummary {
	if x != nil {
		return x.Roles
	}
	return nil
...
var file_apfish_v1_permission_permission_proto_goTypes = []any{
	...
	(*summary5.UserSummary)(nil),     // 7: apfish.v1.user.summary.UserSummary
	(*summary6.RoleSummary)(nil),     // 8: apfish.v1.user.role.summary.RoleSummary
}
var file_apfish_v1_permission_permission_proto_depIdxs = []int32{
	...
	7, // 6: apfish.v1.permission.Permission.users:type_name -> apfish.v1.user.summary.UserSummary
	8, // 7: apfish.v1.permission.Permission.roles:type_name -> apfish.v1.user.role.summary.RoleSummary
