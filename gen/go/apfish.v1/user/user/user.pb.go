...
type User struct {
	...
	Role           *role.RoleSummary               `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"`                                             // Assigned role.
	...
	Contacts       []*contact.ContactSummary       `protobuf:"bytes,7,rep,name=contacts,proto3" json:"contacts,omitempty"`                                     // User's contact methods.
	Permissions    []*permission.PermissionSummary `protobuf:"bytes,8,rep,name=permissions,proto3" json:"permissions,omitempty"`                               // Direct permissions (overrides role).
...
func (x *User) GetRole() *role.RoleSummary {
	if x != nil {
		return x.Role
	}
	return nil
...
func (x *User) GetContacts() []*contact.ContactSummary {
	if x != nil {
		return x.Contacts
	}
	return nil
...
func (x *User) GetPermissions() []*permission.PermissionSummary {
	if x != nil {
