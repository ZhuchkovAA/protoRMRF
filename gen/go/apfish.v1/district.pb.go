...
type District struct {
	...
	Ports         []*PortSummary         `protobuf:"bytes,4,rep,name=ports,proto3" json:"ports,omitempty"`
	Permissions   []*PermissionSummary   `protobuf:"bytes,5,rep,name=permissions,proto3" json:"permissions,omitempty"`
...
func (x *District) GetPorts() []*PortSummary {
	if x != nil {
		return x.Ports
	}
	return nil
...
func (x *District) GetPermissions() []*PermissionSummary {
	if x != nil {
...
const file_apfish_location_district_district_proto_rawDesc = "" +
	...
	"\vpermissions\x18\x05 \x03(\v2\x1d.permission.PermissionSummaryR\vpermissionsB\x14Z\x12apfish.v1;apfishv1b\x06proto3"
