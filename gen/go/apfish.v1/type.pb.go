...
type Type struct {
	...
	Contacts      []*ContactSummary      `protobuf:"bytes,5,rep,name=contacts,proto3" json:"contacts,omitempty"`
...
func (x *Type) GetContacts() []*ContactSummary {
	if x != nil {
		return x.Contacts
	}
	return nil
...
const file_apfish_user_contact_type_type_proto_rawDesc = "" +
	...
	"\bcontacts\x18\x05 \x03(\v2\x1c.user.contact.ContactSummaryR\bcontactsB\x14Z\x12apfish.v1;apfishv1b\x06proto3"
...
var file_apfish_user_contact_type_type_proto_goTypes = []any{
	...
	(*ContactSummary)(nil),        // 2: user.contact.ContactSummary
}
