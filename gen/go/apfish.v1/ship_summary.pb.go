...
// 	protoc        v4.25.1
// source: apfish/ship/ship/ship_summary.proto
...
func (x *ShipSummary) Reset() {
	*x = ShipSummary{}
	mi := &file_apfish_ship_ship_ship_summary_proto_msgTypes[0]
...
func (*ShipSummary) Descriptor() ([]byte, []int) {
	return file_apfish_ship_ship_ship_summary_proto_rawDescGZIP(), []int{0}
}
...
var File_apfish_ship_ship_ship_summary_proto protoreflect.FileDescriptor

const file_apfish_ship_ship_ship_summary_proto_rawDesc = "" +
	"\n" +
	"#apfish/ship/ship/ship_summary.proto\x12\x04ship\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa5\x03\n" +
	...
	"\n" +
	"created_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtB\x14Z\x12apfish.v1;apfishv1b\x06proto3"

var (
	file_apfish_ship_ship_ship_summary_proto_rawDescOnce sync.Once
	file_apfish_ship_ship_ship_summary_proto_rawDescData []byte
)

func file_apfish_ship_ship_ship_summary_proto_rawDescGZIP() []byte {
	file_apfish_ship_ship_ship_summary_proto_rawDescOnce.Do(func() {
		file_apfish_ship_ship_ship_summary_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_apfish_ship_ship_ship_summary_proto_rawDesc), len(file_apfish_ship_ship_ship_summary_proto_rawDesc)))
	})
	return file_apfish_ship_ship_ship_summary_proto_rawDescData
}

var file_apfish_ship_ship_ship_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_apfish_ship_ship_ship_summary_proto_goTypes = []any{
	(*ShipSummary)(nil),           // 0: ship.ShipSummary
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_apfish_ship_ship_ship_summary_proto_depIdxs = []int32{
...
func init() { file_apfish_ship_ship_ship_summary_proto_init() }
func file_apfish_ship_ship_ship_summary_proto_init() {
	if File_apfish_ship_ship_ship_summary_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_apfish_ship_ship_ship_summary_proto_rawDesc), len(file_apfish_ship_ship_ship_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_apfish_ship_ship_ship_summary_proto_goTypes,
		DependencyIndexes: file_apfish_ship_ship_ship_summary_proto_depIdxs,
		MessageInfos:      file_apfish_ship_ship_ship_summary_proto_msgTypes,
	}.Build()
	File_apfish_ship_ship_ship_summary_proto = out.File
	file_apfish_ship_ship_ship_summary_proto_goTypes = nil
	file_apfish_ship_ship_ship_summary_proto_depIdxs = nil
}
