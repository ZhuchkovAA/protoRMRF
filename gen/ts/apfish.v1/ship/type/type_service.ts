...
function createBaseListTypesResponse(): ListTypesResponse {
  return { listTypes: [], total: Long.ZERO };
}
...
export const TypeServiceService = {
  getType: {
    path: "/apfish.v1.ship.type.TypeService/GetType",
    requestStream: false,
  ...
  listTypes: {
    path: "/apfish.v1.ship.type.TypeService/ListTypes",
    requestStream: false,
    responseStream: false,
...
export const TypeServiceClient = makeGenericClientConstructor(
  TypeServiceService,
  "apfish.v1.ship.type.TypeService",
) as unknown as {
