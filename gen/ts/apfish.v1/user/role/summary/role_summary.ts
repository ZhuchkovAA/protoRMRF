...
export const protobufPackage = "apfish.v1.user.role.summary";
...
export const RoleSummary = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RoleSummary {
  ...
  create<I extends Exact<DeepPartial<RoleSummary>, I>>(base?: I): RoleSummary {
    return RoleSummary.fromPartial(base ?? ({} as any));
  },
