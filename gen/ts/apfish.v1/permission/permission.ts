...
import { UserSummary } from "../user/summary/user_summary";
import { ActionSummary } from "./action/summary/action_summary";
import { ObjectSummary } from "./object/summary/object_summary";
...
export const Permission = {
  encode(message: Permission, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.ships) {
      ShipSummary.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    for (const v of message.users) {
      UserSummary.encode(v!, writer.uint32(98).fork()).ldelim();
    }
    for (const v of message.roles) {
      RoleSummary.encode(v!, writer.uint32(106).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13:
          ...
          message.roles.push(RoleSummary.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Permission {
    return {
      ...
      roles: globalThis.Array.isArray(object?.roles) ? object.roles.map((e: any) => RoleSummary.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: Permission): unknown {
    ...
    if (message.roles?.length) {
      obj.roles = message.roles.map((e) => RoleSummary.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Permission>, I>>(object: I): Permission {
    ...
    message.roles = object.roles?.map((e) => RoleSummary.fromPartial(e)) || [];
    return message;
  },
};
